    ...
    <>
      ...
      <div className="max-w-sm mx-auto">
        <form>
          <div className="space-y-4">
            ...
            <div>
              <div className="flex justify-between">
                ...
                <Link
                  className="text-sm font-medium text-indigo-500 hover:text-indigo-400 transition duration-150 ease-in-out ml-2"
                  href="/reset-password"
                >
                  Forgot?
                </Link>
          ...
          <div className="mt-6">
            <button className="btn text-sm text-white bg-indigo-500 hover:bg-indigo-600 w-full shadow-sm group">
              Sign In{" "}
