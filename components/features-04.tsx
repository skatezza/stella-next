...
const FeatureRow = ({ title, features }: FeatureRow) => (
  <div className="py-8 first-of-type:pt-0 last-of-type:pb-0">
    <div>
      <div className="inline-flex font-medium bg-clip-text text-transparent bg-gradient-to-r from-indigo-500 to-indigo-200 pb-6">
        {title}
      </div>
    </div>
...
export default async function Features04() {
  const t = await getI18n();

  const featureRows: FeatureRow[] = [
    {
      title: t("home.features04.sectionTitle1"),
      features: [
        {
          icon: (
            <FeatureIcon>
          ...
          title: t("home.features04.feature1.title"),
          description: t("home.features04.feature1.description"),
        },
        {
          icon: (
            <FeatureIcon>
          ...
          title: t("home.features04.feature2.title"),
          description: t("home.features04.feature2.description"),
        },
        {
          icon: (
            <FeatureIcon>
          ...
          title: t("home.features04.feature3.title"),
          description: t("home.features04.feature3.description"),
        },
      ],
    },
    {
      title: t("home.features04.sectionTitle2"),
      features: [
        {
          icon: (
            <FeatureIcon>
          ...
          title: t("home.features04.feature4.title"),
          description: t("home.features04.feature4.description"),
        },
        {
          icon: (
            <FeatureIcon>
          ...
          title: t("home.features04.feature5.title"),
          description: t("home.features04.feature5.description"),
        },
        {
          icon: (
            <FeatureIcon>
          ...
          title: t("home.features04.feature6.title"),
          description: t("home.features04.feature6.description"),
        },
      ],
    },
    {
      title: t("home.features04.sectionTitle3"),
      features: [
        {
          icon: (
            <FeatureIcon>
          ...
          title: t("home.features04.feature7.title"),
          description: t("home.features04.feature7.description"),
        },
        {
          icon: (
            <FeatureIcon>
        ...
        <div className="pt-16 pb-12 md:pt-32 md:pb-20">
          ...
          <div className="max-w-3xl pb-12 md:pb-20">
            <h2 className="h2 bg-clip-text text-transparent bg-gradient-to-r from-slate-200/60 via-slate-200 to-slate-200/60 pb-4">
              {t("home.features04.title")}
            </h2>
            <p className="text-lg text-slate-400">
              {t("home.features04.subtitle")}
            </p>
          </div>
